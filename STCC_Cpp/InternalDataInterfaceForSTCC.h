...
extern float RealConc_obs[200];
extern float RealFlow_obs[200];
extern float RealSpeed_obs[200];
extern int observation_links_id[200];
extern int num_detectors_per_link[200];
extern int obs_link_nums[200];
extern int G_noofobs;
...
extern int detector_links_id[2000];
extern float vehicle_count[2000];
extern float occupancy[2000];
extern float speed[2000];
...
//extern void ReadDetctorInfo();
//extern void store_updated_realtime_data();
/////////////////////////////////////////////////////////////////////////